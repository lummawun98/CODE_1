...
void setup()
{
  size(600, 600);
  noStroke();
  //expects ( float _xpos, float _ypos, int _width, float _height, float _dist, float _num)
  r1 = new MRect(134.0, 0.1*height, 20, 0.532, 100.0, 4.0);
  r2 = new MRect(44.0, 0.3*height, 2, 0.166, 5.0, 50.0);
  r3 = new MRect(58.0, 0.4*height, 10, 0.332, 10.0, 35.0);
  r4 = new MRect(120.0, 0.9*height, 1, 0.0498, 15.0, 60.0);
}
